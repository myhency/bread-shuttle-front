# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc21 .
# docker tag bread-shuttle-front:v0.0.5-rc21 hencyyeo/bread-shuttle-front:v0.0.5-rc21
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc21
