# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc11 .
# docker tag bread-shuttle-front:v0.0.5-rc11 hencyyeo/bread-shuttle-front:v0.0.5-rc11
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc11
