# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc22 .
# docker tag bread-shuttle-front:v0.0.5-rc22 hencyyeo/bread-shuttle-front:v0.0.5-rc22
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc22
