# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc23 .
# docker tag bread-shuttle-front:v0.0.5-rc23 hencyyeo/bread-shuttle-front:v0.0.5-rc23
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc23
