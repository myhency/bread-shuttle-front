# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc24 .
# docker tag bread-shuttle-front:v0.0.5-rc24 hencyyeo/bread-shuttle-front:v0.0.5-rc24
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc24
