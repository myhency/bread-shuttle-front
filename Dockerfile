# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc5 .
# docker tag bread-shuttle-front:v0.0.5-rc5 hencyyeo/bread-shuttle-front:v0.0.5-rc5
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc5
