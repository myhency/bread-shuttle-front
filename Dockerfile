# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc25 .
# docker tag bread-shuttle-front:v0.0.5-rc25 hencyyeo/bread-shuttle-front:v0.0.5-rc25
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc25
