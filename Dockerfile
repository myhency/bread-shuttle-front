# npm run build
# docker build -t bread-shuttle-front:v0.0.5-rc20 .
# docker tag bread-shuttle-front:v0.0.5-rc20 hencyyeo/bread-shuttle-front:v0.0.5-rc20
# docker push hencyyeo/bread-shuttle-front:v0.0.5-rc20
